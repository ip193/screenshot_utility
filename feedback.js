...
(function( window, document, undefined ) {
        console.log("feedback.js starting")
        if (window.Feedback !== undefined) {
            return;
        }

        var makeJsonString = function (data) {
            let jsonRepresentation = {feedback: data[0], image: data[1], html: data[2], css: data[3]}
            return window.JSON.stringify(jsonRepresentation);
        }
        ...
        var sendRequest = function (data, callback) {
            ...
            xhr.send("data=" + encodeURIComponent(makeJsonString(data)));
        }
...
// script onload function to provide support for IE as well
        ...
        window.Feedback = function (options) {
                ...
                returnMethods = {
                    ...
                    send: function (adapter) {
                        ...
                        if (!options.send_server) {
                            ...
                            //let jsonRepresentation = {feedback:data[0], image:data[1], html:data[2], css:data[3]}
                            download("screenshotJSON.txt", makeJsonString(data));
                        ...
                        if (options.send_server) {
                            ...
                            let callback = function (success) {
                                ...
                                emptyElements(modalBody);  // TODO move this stuff outside, send content through extension popup
                            ...
                            console.log("feedback.js passing data to extension and sending...");
                            let obj = {
                                "type": "send-data",
                                "url":options.url,
                                "dataString": makeJsonString(data),
                            };
            ...
            if (options.appendTo !== null) {
                var append = ((options.appendTo !== undefined) ? options.appendTo : document.body);
                console.log("appending feedback button to: " + append);
        ...
        window.Feedback.Screenshot.prototype.render = function () {
            ...
            if (window.html2canvas === undefined && script === undefined) {
                ...
                console.log("html2canvas not yet loaded");
        ...
        window.Feedback.XHR.prototype.send = sendRequest;
    }
)( window, document );
